...
# Cloud Storage Bucket for Telemetry Logs
...
# Grant BigQuery connection SA read access to the logs bucket
...
# Log Sink for GenAI inference operation logs
...
# Grant log sinks dataEditor on BigQuery dataset
...
# Pre-created GenAI logs export table
